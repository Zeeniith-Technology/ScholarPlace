 ...
 * Route: /student/practice/aptitude-week-3?day=day-1|day-2|day-3|day-4|day-5
 */
function AptitudeWeek3PracticeContent() {
    ...
    const fetchQuestions = async (dayParam: string) => {
        try {
            ...
            const response = await fetch(`${apiBaseUrl}/questions/aptitude-practice`, {
                ...
                body: JSON.stringify({ week: 3, day: parseInt(dayNum) }),
            })
            ...
            <StudentLayout>
                <div className="flex items-center justify-center min-h-[calc(100vh-4rem)]">
                    <Card className="p-12 text-center max-w-md">
                        ...
                        <button
                            onClick={() => router.push(`/student/study/aptitude-week-3?day=${day}`)}
...
export default function AptitudeWeek3PracticePage() {
    return (
        <Suspense fallback={<div className="flex items-center justify-center min-h-screen">
            <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-primary"></div>
        </div>}>
            <AptitudeWeek3PracticeContent />
        </Suspense>
    )
}
