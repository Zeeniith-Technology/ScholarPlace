...
export default function Week2PracticePage() {
  ...
  const days = {
    'day-1': { label: 'Day 1', title: 'Array Operations — Update, Search, Reverse' },
    'day-2': { label: 'Day 2', title: 'Insertion & Deletion with Shifting' },
    'day-3': { label: 'Day 3', title: 'Binary Search - The Divide & Conquer Way' },
    'day-4': { label: 'Day 4', title: 'Two-Pointer Patterns & Prefix Sum' },
    'day-5': { label: 'Day 5', title: 'Comprehensive String Basics' },
  }
      ...
      <StudentLayout>
        <div className="flex items-center justify-center min-h-[calc(100vh-4rem)]">
          <Card className="p-12 text-center max-w-md">
            ...
            <button
              onClick={() => router.push(`/student/study/2?day=${day}`)}
