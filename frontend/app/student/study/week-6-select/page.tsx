...
/**
 * Week 6 Selection Page
 * Allows students to choose between DSA and Aptitude for Week 6
 * Route: /student/study/week-6-select
 */
export default function Week6SelectionPage() {
  ...
  const options = useMemo(() => ([
    {
      ...
      highlights: ['DSA progression', 'Day-wise learning', 'Practice tasks'],
      outline: [
        'Day 1: Week 6 - Day 1',
        'Day 2: Week 6 - Day 2',
        'Day 3: Week 6 - Day 3',
    ...
    },
    {
      ...
      description: 'Profit & loss, simple/compound interest mastery.',
      icon: Calculator,
      route: '/student/study/aptitude-week-6?day=day-1',
      tone: {
      ...
      highlights: ['Profit & loss', 'Simple interest', 'Compound interest'],
      outline: [
        'Day 1: Profit & Loss Fundamentals',
        'Day 2: Advanced P&L - Discounts & Marked Price',
        'Day 3: Simple Interest Complete Mastery',
        'Day 4: Compound Interest Advanced + Effective Rates',
        'Day 5: Complete Integration - Business Scenarios',
      ],
    },
  ]), [])
