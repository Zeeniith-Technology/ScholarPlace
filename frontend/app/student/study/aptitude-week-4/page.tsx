...
/**
 * Week 4 Aptitude Learning Page
 * Interactive learning experience for Quantitative Aptitude
 * Route: /student/study/aptitude-week-4?day=day-1|day-2|day-3|day-4|day-5
 */
function AptitudeWeek4Content() {
  ...
  const days = [
    { id: 'day-1', label: 'Day 1', title: 'Time/Work Advanced Concepts', dayNum: 1 },
    { id: 'day-2', label: 'Day 2', title: 'Time/Work Partnerships & Wage Distribution', dayNum: 2 },
    { id: 'day-3', label: 'Day 3', title: 'Pipes Fundamentals & Combined Pipes', dayNum: 3 },
    { id: 'day-4', label: 'Day 4', title: 'Pipes Advanced - Leaks, Alternate, Cisterns', dayNum: 4 },
    { id: 'day-5', label: 'Day 5', title: 'Time/Work + Pipes Integration', dayNum: 5 },
  ]
  ...
  const fetchStudyContent = async (day: string) => {
    try {
      ...
      const response = await fetch(`${apiBaseUrl}/syllabus/aptitude-week4-content`, {
        method: 'POST',
        credentials: 'include',
        headers: {
  ...
  const navigateToDay = (dayId: string) => {
    router.push(`/student/study/aptitude-week-4?day=${dayId}`)
  }
  ...
  const checkWeeklyTestEligibility = async () => {
    try {
      ...
      const response = await fetch(`${apiBaseUrl}/student-progress/check-weekly-test-eligibility`, {
        ...
        body: JSON.stringify({ week: 4, track: 'aptitude' }),
      })
      if (response.ok) {
  ...
  const checkBlockedRetake = async (): Promise<boolean> => {
    try {
      ...
      const response = await fetch(`${apiBaseUrl}/student-progress/check-blocked-retake`, {
        ...
        credentials: 'include',
        headers: { 'Content-Type': 'application/json', 'Authorization': authHeader },
        body: JSON.stringify({ week: 4, test_type: 'weekly' }),
      })
      if (response.ok) {
        ...
        <div className="flex h-screen overflow-hidden">
          ...
          <div className={cn(
            ...
            <div className="p-4">
              ...
              {/* Back Button */}
              <button
                onClick={() => router.push('/student/study/week-4-select')}
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <div className="font-semibold text-sm">Week 4 Aptitude Test</div>
                        </div>
                    ...
                    <div className="p-6">
                      <div className="flex items-center justify-between">
                        ...
                        {(() => {
                          ...
                          return (
                            <button
                              onClick={() => router.push(`/student/practice/aptitude-week-4?day=${selectedDay}`)}
...
export default function AptitudeWeek4Page() {
  return (
    <Suspense fallback={<div className="flex items-center justify-center min-h-screen">
      <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-primary"></div>
    </div>}>
      <AptitudeWeek4Content />
    </Suspense>
  )
}
