...
/**
 * Week 3 Selection Page
 * Allows students to choose between DSA and Aptitude for Week 3
 * Route: /student/study/week-3-select
 */
export default function Week3SelectionPage() {
  ...
  const options = useMemo(() => ([
    {
      ...
      description: 'Advanced strings and linked list foundations.',
      icon: Code,
      route: '/student/study/3?day=day-1',
      comingSoon: false,
      tone: {
      ...
      highlights: ['String algorithms', 'Linked lists', 'Advanced patterns'],
      outline: [
        'Day 1: String Internals & Advanced Operations',
        'Day 2: String Algorithms & Logic Patterns',
        'Day 3: String Implementations & Robust Parsing',
        'Day 4: Linked Lists – Why & Basic Structure',
        'Day 5: Linked List Core Operations',
      ],
    },
    {
      id: 'aptitude' as const,
      title: 'Quantitative Aptitude',
      description: 'Ratio, proportion, and time/work mastery.',
      icon: Calculator,
      route: '/student/study/aptitude-week-3?day=day-1',
      tone: {
      ...
      highlights: ['Ratio mastery', 'Proportion tools', 'Time/work'],
      outline: [
        'Day 1: Ratio Foundations',
        'Day 2: Advanced Ratio & Partnerships',
        'Day 3: Proportion & Advanced Applications',
        'Day 4: Time/Work – Basic Concepts',
        'Day 5: Time/Work – Advanced Concepts',
      ],
    },
  ]), [])
