...
/**
 * Week 4 Selection Page
 * Allows students to choose between DSA and Aptitude for Week 4
 * Route: /student/study/week-4-select
 */
export default function Week4SelectionPage() {
  ...
  const options = useMemo(() => ([
    {
      ...
      description: 'Advanced linked lists with complete theory and code.',
      icon: Code,
      route: '/student/study/4?day=day-1',
      comingSoon: false,
      tone: {
      ...
      highlights: ['Linked list reversal', 'Cycle detection', 'Merge & sort'],
      outline: [
        'Day 1: Linked List Reversal',
        'Day 2: Cycle Detection',
        'Day 3: Merge & Sort',
        'Day 4: Doubly Linked Lists',
    ...
    },
    {
      ...
      description: 'Time/work and pipes/cisterns mastery.',
      icon: Calculator,
      route: '/student/study/aptitude-week-4?day=day-1',
      tone: {
      ...
      highlights: ['Work rates', 'Pipes & cisterns', 'Integration'],
      outline: [
        'Day 1: Time/Work Advanced Concepts',
        'Day 2: Partnerships & Wage Distribution',
        'Day 3: Pipes Fundamentals & Combined Pipes',
        'Day 4: Pipes Advanced - Leaks, Cisterns',
        'Day 5: Time/Work + Pipes Integration',
      ],
    },
  ]), [])
