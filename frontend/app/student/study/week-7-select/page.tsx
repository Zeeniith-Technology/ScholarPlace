...
/**
 * Week 7 Selection Page
 * Week 7 is a consolidation week — no daily lessons. Students choose between the
 * mixed mock test and the coding capstone, which together complete the week
 * (capstone done AND weekly test >= 75%).
 * Route: /student/study/week-7-select
 */
export default function Week7SelectionPage() {
  ...
  const options = useMemo(() => ([
    {
      ...
      description: 'Five days of mixed coding practice, then the capstone.',
      icon: Code,
      route: '/student/study/7?day=day-1',
      comingSoon: false,
      tone: {
      ...
      outline: [
        ...
        'Capstone: Merge Intervals + Product Except Self',
        'Capstone must pass to complete the week',
      ],
    },
    {
      id: 'aptitude' as const,
      title: 'Aptitude — Daily Practice',
      description: 'Five days of mixed practice, then the mock test.',
      icon: Calculator,
      route: '/student/study/aptitude-week-7?day=day-1',
      tone: {
      ...
      highlights: ["50 questions a day", "All six areas", "Mock test at the end"],
      outline: [
        'Day 1-5: 50 questions each',
        'Mixed topics across all six areas',
        'Scored on submission',
        'Weekly mock test: 50 questions',
        'Pass mark 75% to complete the week',
      ],
    },
  ]), [])
