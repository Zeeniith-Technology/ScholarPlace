...
function AptitudeWeek1Content() {
  ...
  const navigateToDay = (dayId: string) => {
    router.push(`/student/study/aptitude-week-1?day=${dayId}`)
  }
        ...
        <div className="flex h-screen overflow-hidden">
          ...
          <div className={cn(
            ...
            <div className="p-4">
              ...
              {/* Back Button */}
              <button
                onClick={() => router.push('/student/study/week-1-select')}
              ...
              {/* Weekly Test Box - Only show on last day (day-5) */}
              {selectedDay === 'day-5' && (
          ...
          <div className="flex-1 flex flex-col overflow-hidden">
            ...
            <div className="bg-background-surface border-t border-neutral-light/20 p-4">
              <div className="flex items-center justify-between max-w-4xl mx-auto">
                ...
                {/* Slides indicator - consistent pagination style */}
